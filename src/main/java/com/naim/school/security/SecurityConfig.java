...
import com.naim.school.activitylog.ActivityAction;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/users/**", "/settings/**", "/academic-sessions/**", "/teacher-sessions/**", "/activity-log/**").hasAuthority("ROLE_ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/students/**", "/students/certificate/**", "/notices/**",
                ...
                .logout(logout -> logout.logoutUrl("/logout").logoutSuccessUrl("/login?logout")
                        .addLogoutHandler((request, response, authentication) -> {
                            if (authentication != null) {
                                activityLogService.logAs(authentication.getName(),
                                        ActivityAction.LOGOUT, "Auth", "Logged out.");
                            }
                        })
                        .permitAll());
