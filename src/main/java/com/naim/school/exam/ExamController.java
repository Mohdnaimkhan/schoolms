...
public class ExamController {
    ...
    @PostMapping("/save")
    public String save(@ModelAttribute Exam exam, RedirectAttributes redirectAttributes) {

        boolean isNew = exam.getId() == null;
        Exam saved = examService.save(exam);

        redirectAttributes.addFlashAttribute("success",
                isNew ? "Exam added successfully." : "Exam updated successfully.");

        if (isNew) {
            activityLogService.logCreate("Exam", "Added exam " + saved.getExamName());
        } else {
            activityLogService.logUpdate("Exam", "Updated exam " + saved.getExamName());
        }
    ...
    public String delete(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        ...
        activityLogService.logDelete("Exam", "Deleted exam " + exam.getExamName());
    ...
    public String addSubject(
        ...
        redirectAttributes.addFlashAttribute("success", "Subject added to exam successfully.");

        activityLogService.logCreate("Exam", "Added subject #" + subjectId + " to exam #" + examId);
    ...
    public String deleteSubject(
        ...
        redirectAttributes.addFlashAttribute("success", "Subject removed from exam successfully.");

        activityLogService.logDelete("Exam", "Removed subject #" + examSubjectId + " from exam #" + examId);
