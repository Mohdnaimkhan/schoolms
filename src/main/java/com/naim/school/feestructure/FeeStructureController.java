...
public class FeeStructureController {
    ...
    @PostMapping("/save")
    public String save(@ModelAttribute FeeStructure feeStructure, RedirectAttributes redirectAttributes) {

        boolean isNew = feeStructure.getId() == null;
        feeStructureService.save(feeStructure);

        redirectAttributes.addFlashAttribute("success",
                isNew ? "Fee structure added successfully." : "Fee structure updated successfully.");

        if (isNew) {
            activityLogService.logCreate("Fee Structure", "Added fee structure #" + feeStructure.getId());
        } else {
            activityLogService.logUpdate("Fee Structure", "Updated fee structure #" + feeStructure.getId());
        }
    ...
    public String delete(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("success", "Fee structure deleted successfully.");

        activityLogService.logDelete("Fee Structure", "Deleted fee structure #" + id);
