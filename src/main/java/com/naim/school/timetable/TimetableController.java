...
public class TimetableController {
    ...
    @PostMapping("/save")
    public String save(@ModelAttribute Timetable timetable, RedirectAttributes redirectAttributes) {

        boolean isNew = timetable.getId() == null;
        timetableService.save(timetable);

        redirectAttributes.addFlashAttribute("success",
                isNew ? "Timetable entry added successfully." : "Timetable entry updated successfully.");

        if (isNew) {
            activityLogService.logCreate("Timetable", "Added timetable entry #" + timetable.getId());
        } else {
            activityLogService.logUpdate("Timetable", "Updated timetable entry #" + timetable.getId());
        }
    ...
    public String delete(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("success", "Timetable entry deleted successfully.");

        activityLogService.logDelete("Timetable", "Deleted timetable entry #" + id);
